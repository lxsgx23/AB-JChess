...
constexpr std::string_view version = "0.1b";
...
static std::string build_date_yyyymmdd() {
    constexpr std::string_view months("Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec");
...
std::string engine_info(bool to_uci) {
    if (to_uci)
        return "AB JChess 0.1b\nid author Huorongrong,Laoxu(Kouza)";

    return "AB JChess " + build_date_yyyymmdd() + " by Huorongrong,Laoxu(Kouza)\n"
